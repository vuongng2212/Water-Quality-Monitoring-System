...
- **Cơ sở dữ liệu:** PostgreSQL (Quản lý qua Spring Data JPA/Hibernate)
...
2.  **Cấu hình Môi trường:**
    ...
    _Lưu ý: Thay đổi `jwt.secret` thành một chuỗi bí mật của riêng bạn. Đối với email, nếu dùng Gmail, cần tạo App Password thay vì mật khẩu thông thường._

3.  **Khởi chạy Cơ sở dữ liệu:**
    Dự án đã có sẵn tệp `docker-compose.yml` để khởi tạo một container PostgreSQL. Chạy lệnh sau từ thư mục gốc của backend:
